...
class TestWorker
{
 public:
   ...
   ulxr::MethodResponse                                                                                                                                                         (const ulxr::MethodCall &calldata)
   {
...
int main(int argc, char **argv)
{
...
#ifdef _MSC_VER
  {
    ...
    server.addMethod(ulxr::make_method(worker, &TestWorker:: ),
                     ulxr::Signature(ulxr::Struct()),
                     ULXR_PCHAR(" _in_class_dynamic"),
